...
export const ALL_FEATURES: { id: FeatureId; label: string; description: string }[] = [
  ...
  { id: 'custom_commands', label: 'Custom Commands', description: 'User-defined bot commands (Telegram)' },
  { id: 'ecommerce', label: 'E-Commerce', description: 'Shop and sell products via Telegram' },
  { id: 'chatbot_flows', label: 'Chatbot Flows', description: 'Multi-step conversational flows (Telegram)' },
