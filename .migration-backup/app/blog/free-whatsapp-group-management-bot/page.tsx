...
export default function Article() {
  return <BlogArticle content={content} date="May 8, 2026" readTime="7 min read" slug="free-whatsapp-group-management-bot" relatedPosts={relatedPosts} {...(blogMeta['free-whatsapp-group-management-bot'] ?? { faqs: [], description: '', keywords: [] })} />;
}
