...
export const recentBlogPosts: RecentPost[] = [
  ...
  {
    slug: 'telegram-bot-vs-discord-bot',
    title: 'Telegram Bot vs Discord Bot',
    description: 'Side-by-side comparison: which bot platform fits your community better in 2026.',
    publishedAt: '2026-05-18',
    readMinutes: 8,
  },
  {
    slug: 'telegram-bot-for-schools-campus-groups',
    title: 'Telegram Bot for Schools and Campus Groups',
    description: 'How student leaders use BotWave to keep 500+ member campus groups running cleanly.',
    publishedAt: '2026-05-13',
    readMinutes: 6,
  },
  {
    slug: 'telegram-bot-south-africa',
    title: 'Telegram Bot for South Africa',
    description: 'Free Telegram group automation tuned for South African communities and businesses.',
    publishedAt: '2026-05-13',
    readMinutes: 5,
  },
];
