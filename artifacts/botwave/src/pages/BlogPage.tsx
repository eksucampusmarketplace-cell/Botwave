...
const posts = [
  ...
  { slug: 'telegram-bot-automation', title: 'Telegram Bot Automation (2026)', excerpt: 'Automate your Telegram groups with BotWave bot mode. Auto-replies, AI chat, media tools - all from a web dashboard.', date: '2026-05-16', readTime: '8 min read', tags: ['Telegram', 'Telegram Bot', 'Automation'] },
