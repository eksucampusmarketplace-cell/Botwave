...
const SAMPLE_POSTS: GuestPost[] = [
  { id: '1', author_name: 'Emeka O.', title: 'BotWave saved my Telegram group!', body: 'I was spending 2 hours daily managing my 500-member group. After setting up BotWave, the anti-spam and welcome messages handle everything automatically. Highly recommended!', original_lang: 'en', display_lang: 'en', upvotes: 42, created_at: new Date(Date.now() - 3 * 24 * 60 * 60 * 1000).toISOString() },
  { id: '2', author_name: 'Fatima A.', title: 'The sticker maker is incredible', body: 'My students love that they can make custom stickers right inside our Telegram group. No need for separate apps. BotWave makes it so easy.', original_lang: 'en', display_lang: 'en', upvotes: 38, created_at: new Date(Date.now() - 5 * 24 * 60 * 60 * 1000).toISOString() },
  ...
  { id: '4', author_name: 'Priya S.', title: 'AI commands in Telegram are game-changing', body: 'The Telegram bot with AI commands is perfect for our study group. Anyone can ask a question and get an instant AI response. We use it every day.', original_lang: 'en', display_lang: 'en', upvotes: 29, created_at: new Date(Date.now() - 10 * 24 * 60 * 60 * 1000).toISOString() },
];
