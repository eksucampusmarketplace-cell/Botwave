    ...
    <main className="min-h-screen bg-[var(--bg)]">
      ...
      <div className="pt-32 pb-20 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mt-8 p-8 rounded-2xl bg-gradient-to-r from-green-600/10 to-blue-600/10 border border-green-500/20 text-center">
            <h2 className="text-2xl font-bold text-[var(--text-primary)] mb-3">Want an integration we don't support yet?</h2>
