...
const botFeatures = [
  ...
  { icon: '🌐', title: 'Proxy Support', desc: 'Route connection through SOCKS5 or HTTP proxy.' },
  { icon: '🎭', title: 'Auto Responses', desc: 'Set up keyword-triggered auto-replies for your group.' },
];
    ...
    <main className="min-h-screen bg-[var(--bg)]">
      ...
      <section className="pt-32 pb-16 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-[var(--text-secondary)] max-w-2xl mx-auto mb-8">
            Deploy a Telegram bot with anti-spam, captcha, welcome messages, anti-raid,
      ...
      <section className="py-16 px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-center text-[var(--text-secondary)] mb-10">Official Bot API — zero ban risk. One-click setup via @BotFather.</p>
      ...
      <section className="py-16 px-6 bg-[var(--bg-alt)]">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl font-bold text-[var(--text-primary)] mb-4">Why use a Telegram Bot?</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-10 text-left">
            <div className="p-6 rounded-2xl bg-blue-500/5 border border-blue-500/20">
              <h3 className="font-bold text-blue-500 mb-3">Zero Ban Risk</h3>
              <p className="text-sm text-[var(--text-secondary)]">Uses the official Telegram Bot API. Fully sanctioned by Telegram — your bot is safe.</p>
            </div>
            <div className="p-6 rounded-2xl bg-blue-500/5 border border-blue-500/20">
              <h3 className="font-bold text-blue-500 mb-3">30-Second Setup</h3>
              <p className="text-sm text-[var(--text-secondary)]">Get a token from @BotFather, paste it into BotWave, and your bot is live immediately.</p>
            </div>
            <div className="p-6 rounded-2xl bg-blue-500/5 border border-blue-500/20">
              <h3 className="font-bold text-blue-500 mb-3">Full Admin Control</h3>
              <p className="text-sm text-[var(--text-secondary)]">Kick, ban, mute, warn, and manage members. Your bot has admin power when you give it admin rights.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-6 text-center">
        <div className="max-w-2xl mx-auto">
          <h2 className="text-3xl font-bold text-[var(--text-primary)] mb-4">Start free today</h2>
          <p className="text-[var(--text-secondary)] mb-8">Connect your Telegram Bot and automate your group in under 2 minutes.</p>
