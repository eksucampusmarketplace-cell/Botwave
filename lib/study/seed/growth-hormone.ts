...
export const growthHormoneMaterial = {
  ...
  summary: {
    ...
    keyPoints: [
      ...
      '### Mechanism of Action',
      'GH acts mainly through IGF-I (Somatomedin C), produced by the liver and other tissues',
      ...
      '### Stimulators of GH',
      'GHRH, sleep, exercise, insulin, hypoglycaemia',
      '### Inhibitors of GH',
      'Somatostatin (GHIH), aging, obesity, exogenous GH, ↑blood glucose, ↑free fatty acids',
      '### Hyposecretion — Dwarfism',
      'GH deficiency in children → Dwarfism',
      'Types of dwarfism: 1) Lack of GH, 2) Lack of GH receptors (e.g. African Pygmies), 3) GH Insensitive Syndrome (Laron dwarfism — defective GH receptors)',
      'Features: short stature, micropenis, hypoglycaemia',
      'Treatment: Human GH (hGH) replacement (NOT effective in Laron — must use IGF-I)',
      '### Hypersecretion — Acromegaly & Gigantism',
      'In ADULTS → Acromegaly (epiphyses closed → only cartilage grows)',
      'Acromegaly features: thick lips, macroglossia, broad nose, prominent eyebrows, prognathism, thickened skin, coarse facial features',
      'In CHILDREN → Gigantism (epiphyses open → linear bone growth)',
      'Gigantism features: abnormal height (7-8 ft), large hands/feet, coarse features, bilateral gynaecomastia',
    ],
