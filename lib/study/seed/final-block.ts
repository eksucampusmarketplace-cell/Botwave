...
export const finalBlockMaterial = {
  ...
  summary: {
    ...
    keyPoints: [
      ...
      '### Functions/Effects',
      'Insulin on glucose: ↓blood glucose, ↑GLUT-4 uptake, ↑glycogenesis, ↓gluconeogenesis',
      'Insulin on fat: ↑lipogenesis, ↓lipolysis. On protein: ↑synthesis, ↓breakdown (anabolic)',
      'Glucagon on liver: ↑glycogenolysis, ↑gluconeogenesis, ↑ketogenesis, ↑lipolysis',
      '### Regulation',
      'Insulin stimulators: ↑blood glucose (most important), amino acids (arginine, leucine), GI hormones (GLP-1, GIP), parasympathetic, sulfonylureas',
      'Insulin inhibitors: hypoglycaemia, sympathetic (α-adrenergic), somatostatin',
      '### Abnormalities',
      'Type 1 DM: autoimmune β-cell destruction, absolute insulin deficiency, HLA-DR3/DR4, prone to DKA',
      'Type 2 DM: insulin resistance → β-cell failure, genetic/lifestyle, prone to HHS',
      'Gestational DM: placental hormones → insulin resistance → foetal macrosomia',
      'DKA = ONLY Type 1 (absolute deficiency). HHS = Type 2',
      '### Clinical Features',
      'DKA: hyperglycaemia, Kussmaul breathing, fruity breath, metabolic acidosis',
      'Insulinoma: excess insulin → hypoglycaemia (confusion, sweating, tremor)',
      'Glucagonoma: hyperglycaemia + necrolytic migratory erythema + weight loss',
      '### Diagnosis',
      'OGTT: fasting glucose → 75g oral glucose → check at 1, 2, 3 hrs. Normal <6.1 mmol/L, Diabetic ≥7.0 mmol/L',
      'C-peptide: distinguishes endogenous vs exogenous insulin',
      '### Treatment',
      'Type 1: insulin replacement. Type 2: lifestyle + metformin + insulin if needed',
      'Glucagon emergency use: treats severe hypoglycaemia',
      ...
      '### Definition',
      'Paired retroperitoneal endocrine glands (4-6g each). Cortex = mesodermal origin (steroids). Medulla = neural crest origin (catecholamines)',
      '### Basic Properties',
      'Anatomy: Right = pyramidal, Left = crescent-shaped. Triple arterial supply. Right vein → IVC, Left vein → Left renal vein',
      'Cortex 3 zones (GFR = "Salt, Sugar, Sex"): 1) Glomerulosa → Aldosterone, 2) Fasciculata → Cortisol, 3) Reticularis → Androgens (DHEA)',
      'Medulla: chromaffin cells. Synthesis: Tyrosine → DOPA → Dopamine → Norepinephrine → Epinephrine',
      '### Functions/Effects',
      ...
      '### Abnormalities',
      'Cushing\'s syndrome: excess cortisol (pituitary adenoma, adrenal tumour, steroid therapy)',
      'Addison\'s disease: primary adrenal insufficiency (autoimmune, TB)',
      'Conn\'s syndrome: primary hyperaldosteronism (adrenal adenoma)',
      'Phaeochromocytoma: chromaffin cell tumour → excess catecholamines',
      '### Clinical Features',
      'Cushing\'s: moon face, buffalo hump, hypertension, diabetes, muscle wasting, truncal obesity',
      'Addison\'s: weakness, hypotension, hyperpigmentation, hyponatraemia, hyperkalaemia',
      'Conn\'s: hypertension, hypokalaemia, metabolic alkalosis',
      '### Diagnosis',
      'Cushing\'s: 24h urinary cortisol, dexamethasone suppression test. Addison\'s: ACTH stimulation test. Phaeochromocytoma: urinary catecholamines/metanephrines',
      '### Treatment',
      'Cushing\'s: remove cause (surgery, stop steroids). Addison\'s: hydrocortisone + fludrocortisone. Conn\'s: spironolactone or surgery',

      '## MALE REPRODUCTIVE ORGANS',
      '>> The testes produce sperm (exocrine) and testosterone (endocrine). Spermatogenesis is regulated by the HPG axis.',
      '### Definition',
      'Primary male sex organs (testes) with dual function: spermatogenesis + testosterone production',
      '### Basic Properties',
      'Sertoli cells: support/nourish sperm, blood-testis barrier (BTB), secrete inhibin (inhibits FSH) + ABP',
      'Leydig cells: interstitial, produce testosterone in response to LH',
      'Accessory glands: Seminal vesicles (60%, fructose), Prostate (30%, alkaline, PSA), Bulbourethral (lubrication)',
      'Duct system: Epididymis → Vas deferens → Ejaculatory duct → Urethra',
      '### Functions/Effects',
      'Spermatogenesis (~74 days): Spermatogonia → Primary spermatocyte → [Meiosis I] → Secondary → [Meiosis II] → Spermatids → [Spermiogenesis] → Spermatozoa',
      'Sperm capacitation: occurs in female tract → removes glycoprotein coat → enables acrosome reaction',
      'Testosterone: 1) Primary sex characteristics, 2) Secondary (deep voice, facial hair, muscle mass, bone growth), 3) Spermatogenesis (essential)',
      '### Regulation',
      'HPG axis: GnRH → FSH + LH. Also: temperature, vitamins (E, A, C, B complex), thyroid hormones, testosterone',
      '### Abnormalities',
      'Cryptorchidism: undescended testis. Requires AMH + testosterone for descent. Risk: infertility, testicular cancer',
      '### Clinical Features',
      'Cryptorchidism: increased risk of testicular cancer if uncorrected. Infertility from impaired spermatogenesis',
      '### Treatment',
      'Cryptorchidism: orchidopexy (surgical). Hypogonadism: testosterone replacement',
      ...
      '### Functions/Effects',
      'Blood flow: Placenta → Umbilical vein → Ductus venosus → IVC → RA → Foramen Ovale → LA → LV → Aorta → Brain/Heart first',
      'Most oxygenated blood goes to BRAIN and HEART first via foramen ovale → left heart → ascending aorta',
      '### Postnatal Closure Pathway',
      'Lungs expand → ↓pulmonary resistance → FO closes (becomes fossa ovalis). ↑O₂ → DA closes (becomes ligamentum arteriosum)',
      'Umbilical vein → ligamentum teres. Ductus venosus → ligamentum venosum',
      'Prostaglandins keep DA OPEN. Indomethacin (PG inhibitor) closes patent DA after birth',
      '### Clinical Significance',
      'Patent ductus arteriosus (PDA): failure to close → left-to-right shunt → pulmonary overload. Treatment: indomethacin or surgical ligation',
      'Patent foramen ovale (PFO): usually benign, risk of paradoxical embolism',
      ...
      '### Definition',
      'Reproductive system regulated by HPG axis through coordinated ovarian and uterine cycles',
      '### Basic Properties',
      'Ovarian cycle: Follicular (days 1-14, FSH-driven) → Ovulation (day 14, LH surge) → Luteal (days 14-28, progesterone)',
      'Uterine cycle: Menstrual (days 1-5) → Proliferative (days 5-14, estrogen) → Secretory (days 14-28, progesterone)',
      'Correlation: Follicular = Proliferative (estrogen). Luteal = Secretory (progesterone)',
      '### Functions/Effects',
      'Estrogen: secondary sex characteristics, endometrial proliferation, ↑uterine blood flow, cervical mucus thinning, bone growth, ↑HDL/↓LDL',
      'Progesterone: secretory endometrium, maintains pregnancy, ↑basal body temp (+0.5°C), thick cervical mucus, breast lobular development',
      '### Regulation',
      'LH surge: rising estrogen → positive feedback → massive LH release → ovulation',
      'Corpus luteum → progesterone. No fertilization → degenerates → menstruation. If fertilized: hCG rescues corpus luteum',
      '### Abnormalities',
      'Menopause (age ~51): follicle depletion → ↓estrogen → ↑FSH/LH. Hot flushes, osteoporosis',
      '### Clinical Features',
      'Puberty (menarche): GnRH pulsatile → FSH/LH. Age 11-13. Requires ~17% body fat',
      '### Treatment',
      'Contraception: OCP (estrogen + progesterone) → suppress FSH/LH → no ovulation, thicken cervical mucus',
      ...
      '### Definition',
      'Fertilization (ampulla of fallopian tube) → implantation (~6-7 days) → placental development → parturition',
      '### Basic Properties',
      'Sperm: capacitation → acrosome reaction → penetrates zona pellucida → cortical reaction (prevents polyspermy)',
      'Placental hormones: 1) hCG (maintains corpus luteum, peaks 8-10 wks), 2) hPL (anti-insulin), 3) Estrogen + Progesterone',
      '### Functions/Effects',
      'Maternal changes: ↑blood volume (40-50%), ↑cardiac output, ↑GFR, ↑tidal volume, ↑BMR, insulin resistance',
      ...
      'Lactational amenorrhoea: prolactin suppresses GnRH → no ovulation (~98% effective first 6 months)',
      ...
      '### Definition',
      'Central nervous system: brain + spinal cord. Spinal cord extends from foramen magnum to lower border of L1',
      '### Basic Properties',
      'Two enlargements: cervical (upper limb) and lumbar (lower limb). 31 pairs of spinal nerves: 8C, 12T, 5L, 5S, 1Co',
      'Dorsal root = sensory (afferent). Ventral root = motor (efferent). 5 plexuses each side',
      'Brain regions: Cerebral cortex (sensory/motor/speech), Basal ganglia (movement), Cerebellum (coordination), Hypothalamus (endocrine), Brain stem (vital centres)',
      '12 cranial nerves: I-Olfactory, II-Optic, III-Oculomotor, IV-Trochlear, V-Trigeminal, VI-Abducens, VII-Facial, VIII-Vestibulocochlear, IX-Glossopharyngeal, X-Vagus, XI-Accessory, XII-Hypoglossal',
      '### Functions/Effects',
      'Reflexes: 1) Stretch (commonest), 2) Withdrawal, 3) Crossed extensor, 4) Inverse stretch. Arc: Receptor → Afferent → Centre → Efferent → Effector',
      'Sleep: NREM (70-80%, slow wave) and REM (20-30%, memory consolidation, vivid dreams)',
      '### Abnormalities',
      ...
      '2) Anterior spinal artery: motor paralysis + pain/temp loss bilaterally, proprioception PRESERVED',
      '3) Central cord: most common incomplete injury. Upper > lower limbs. Elderly hyperextension',
      '4) Cauda equina: below L1-L2 → LMNL + saddle anaesthesia + bladder/bowel dysfunction. SURGICAL EMERGENCY',

      '## SCOTOPIC & PHOTOPIC VISION',
      '>> The retina has two photoreceptor types: rods (night vision) and cones (daylight/colour vision).',
      '### Definition',
      'Two visual systems: Scotopic (rod-mediated, dim light) and Photopic (cone-mediated, bright light/colour)',
      '### Basic Properties',
      'Rods: very high sensitivity (single photon), achromatic, low acuity, peripheral retina, peak 507 nm. Pigment: Rhodopsin (needs vitamin A)',
      'Cones: high acuity, colour (trichromatic), concentrated in fovea, peak 555 nm. Types: S-blue (420nm), M-green (530nm), L-red (560nm)',
      'Dark adaptation: rods 20-30 min, cones 5-7 min (faster)',
      'Fovea centralis: ONLY cones → maximum acuity. Optic disc (blind spot): NO photoreceptors',
      '### Functions/Effects',
      ...
      '### Functions/Effects',
      'VPL: body sensations → postcentral gyrus. VPM: face sensations → postcentral gyrus',
      'VL: motor (globus pallidus + cerebellum) → motor cortex. LGB: vision → visual cortex. MGB: hearing → auditory cortex',
      'Anterior: emotion/memory (Papez circuit). Mediodorsal: cognition, personality (prefrontal cortex)',
      ...
      '### Clinical Significance',
      'Thalamic pain syndrome (Dejerine-Roussy): VPL/VPM damage → contralateral spontaneous burning pain',
