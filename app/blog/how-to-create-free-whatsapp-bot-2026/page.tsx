...
export default function Article() {
  return <BlogArticle content={content} date="May 1, 2026" readTime="5 min read" slug="how-to-create-free-whatsapp-bot-2026" relatedPosts={relatedPosts} {...(blogMeta['how-to-create-free-whatsapp-bot-2026'] ?? { faqs: [], description: '', keywords: [] })} />;
}
